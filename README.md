...
|---------------|-----------|------|------------|------------|------|
| 👀 [ShoppingFourU]([https://github.com/JungyoYang/number-game](https://github.com/kt-cloud-basic-project/shopping)) | ![[ShoppingFourU](https://github.com/jungyoyang/JungyoYang/blob/main/assets/Group_4_1.png) | 숫자 쌍을 선택하여 10을 만드는 퍼즐 게임. 백트래킹/BFS 기반의 경로 제약 로직과 보너스 라운드 시스템 구현 |Java, Spring Boot, JPA, MySQL, Swagger, Docker, IntelliJ, GitHub, Gradle, Discord, Notion, Jira, GitHub Issues, Postman, Swagger UI | 2026.01 | 5명 |
