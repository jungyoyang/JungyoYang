...
|---------------|-----------|------|------------|------------|------|
| 🥬 [Vegetable Price AI](https://github.com/JungyoYang/JungyoYang/blob/main/assets/vegetable_price_ai.pdf) | 기온 데이터를 기반으로 토마토 가격을 선형 회귀로 예측한 인공지능 프로젝트 | Python, NumPy, scikit-learn, matplotlib | 2024.06 | 3명 |
