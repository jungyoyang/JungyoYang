...
|---------------|-----------|------|------------|------------|------|
| 🛒 [ShoppingFourU](https://github.com/kt-cloud-basic-project/shopping) | ![ShoppingFourU Architecture](https://github.com/kt-cloud-basic-project/shopping/blob/main/docs/architecture.png?raw=true) | 에이전틱 커머스를 가정한 이커머스 백엔드 플랫폼. 낙관적 락과 재고 예약 시스템을 통해 동시성 환경에서도 결제·재고 데이터 정합성을 보장하고, 실시간 로그 수집 기반의 운영 안정성 및 AI 추천 학습 데이터 파이프라인을 설계 | Java, Spring Boot, JPA, MySQL, Docker, ELK | 2026.01 | 5명 |
